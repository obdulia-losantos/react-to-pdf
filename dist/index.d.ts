...
import { Options as Options$1 } from 'html2canvas-pro';
...
type CanvasConversionOptions = Pick<Options$1, "useCORS" | "logging"> & {
    /**
...
type ConversionOptions = {
    ...
    overrides: {
         ...
         * */
        canvas?: Partial<Options$1>;
    };
};
type Options = Omit<Partial<ConversionOptions>, "page" | "canvas" | "overrides"> & {
...
declare const usePDF: (usePDFoptions?: Options) => UsePDFResult;
...
export { Margin, Resolution, generatePDF as default, usePDF };
export type { Options };
